...
class ShowTest extends TestCase
{
    ...
    /** @test **/
    public function it_returns_correct_code_for_fields_in_show()
    {
        $table = $this->mock(Table::class, function ($mock) {
            $mock->shouldReceive('getModelVariableName')->once()->andReturn('credential');
        ...
        $show = new Show($table, $nostubs = true);

        $this->assertMatchesSnapshot($show->getFields());
    }

    /** @test **/
    public function it_returns_correct_code_for_table_in_show()
    {
        $table = $this->mock(Table::class, function ($mock) {
            $mock->shouldReceive('getModelVariableName')->once()->andReturn('credential');
            $mock->shouldReceive('getColumnsWithMetadata')->once()->andReturn(static::COLUMNS);
        ...
        $this->assertMatchesSnapshot($show->getShow());
    }
}
